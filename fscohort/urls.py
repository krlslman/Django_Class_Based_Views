...
from .views import HomeView, StudentListView, StudentCreateView, StudentUpdateView, StudentDetailView, StudentDeleteView
from django.views.generic import TemplateView

urlpatterns = [
    # path('', home, name="home"),
    path('', HomeView.as_view(), name="home"),
    # path('', TemplateView.as_view(template_name="fscohort/home.html"), name="list"),
